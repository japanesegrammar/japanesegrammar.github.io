...
_KNOWN_VOCAB_LIST = [Vocab('勉強', 'study'),
                     ...
                     Vocab('水泳', 'swimming'),
                     Vocab('ドア', 'door', isItKanji=False),
                     Vocab('国', 'country; hometown'),
                     Vocab('帰る', 'to return; to come home'),
                     Vocab('寂しい', 'lonely'),
                     Vocab('子供', 'child​'),
                     Vocab('時', 'time; hour; moment'),
                     Vocab('冬', 'winter'),
                     Vocab('風邪', 'common cold'),
                     Vocab('ひく', 'to catch a cold'),
                     Vocab('秋', 'autumn; fall​'),
                     Vocab('木', 'tree'),
                     Vocab('赤い', 'red; crimson'),
